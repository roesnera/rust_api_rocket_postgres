...
use crate::{models::{NewCrate,Crate, User}, repositories::CrateRepository};
...
pub async fn update_crate(id: i32, da_crate: Json<Crate>, db: DbConn, _user: User) -> Result<Value, Custom<Value>> {
    db.run(move |c| {
